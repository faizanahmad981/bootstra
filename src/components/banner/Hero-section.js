    ...
    <div className="hero-text">
     ...
     {/*  <div className="hero-buttons">
      ...
      <div className="d-flex justify-content-start gap-3 flex-wrap">
        {/* Order Now Button */}
        <button className="btn btn-primary btn-lg px-4 py-2" type="button">
          Order Now
        </button>

        {/* Watch Video Button with Watch Icon */}
        <button className="btn btn-outline-secondary btn-lg px-4 py-2" type="button">
